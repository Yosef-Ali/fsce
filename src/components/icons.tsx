...
export const GithubIcon: React.FC<IconProps> = ({ title, ...props }) => (
  <svg
    className="w-6 h-6 hover:text-gray-500 duration-150"
    fill="none"
    viewBox="0 0 48 48"
...
export const FacebookIcon: React.FC<IconProps> = ({ title, ...props }) => (
  ...
  >
    ...
    <g clipPath="url(#facebook-clip-path)">
      <path
        fill="currentColor"
...
export const EmailIcon: React.FC<IconProps> = ({ title, ...props }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 24 24"
    className="w-6 h-6 hover:text-gray-500 duration-150"
...
export const TelephoneIcon: React.FC<IconProps> = ({ title, ...props }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 24 24"
    className="w-6 h-6 hover:text-gray-500 duration-150"
...
export const FaxIcon: React.FC<IconProps> = ({ title, ...props }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 24 24"
    className="w-6 h-6 hover:text-gray-500 duration-150"
